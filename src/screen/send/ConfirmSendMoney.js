            ...
            <div className="lg:w-5/12 xl:w-4/12 2xl:w-3/12 lg:mx-auto   h-full ">
                ...
                <div className="mt-6 w-full pl-2 pr-2">
                    <div className="bg-gray-100 h-20 border rounded-lg">
                        <p className="text-start text-sm pt-3 ml-3">Receiver</p>
                ...
                <div className="lg:w-5/12 xl:w-1/4 2xl:w-1/4 bg-violet-500 absolute bottom-0 ">
                    <div className="mx-auto h-16" onClick={handleTransfer}>
                        <button className="text-white pl-2 pr-2 pt-6">Proceed</button>
                    </div>
                </div>
            </div>
        </div>
