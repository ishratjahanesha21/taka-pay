...
import { createCashOut } from '../../state/transaction/cashOutSlice';
    ...
    return (
        <div className="h-screen border rounded-lg lg:w-2/4 2xl:w-5/12 mx-auto shadow-lg">
            <div className="w-full">
                ...
                <div className="w-full md:w-3/4 lg:w-7/12 xl:w-6/12 2xl:w-5/12 mx-auto fixed bottom-0 " style={{ backgroundColor: '#000814' }}>
                    <div className="h-12 flex items-center justify-center" onClick={handleTransfer}>
                        <button className="text-white pl-2 pr-2 ">Proceed</button>
                    </div>
                </div>
            </div>
        </div>
